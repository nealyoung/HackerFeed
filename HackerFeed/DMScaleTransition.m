    ...
    if (self.isPresenting) {
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext]
                         animations:^{
                             ...
                             fromVC.view.transform = CGAffineTransformScale(fromVC.view.transform, 0.9f, 0.9f);
                         }
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext]
                         animations:^{
                             ...
                             fromVC.view.transform = CGAffineTransformScale(xForm, 2.0f, 2.0f);
                             toVC.view.transform = CGAffineTransformScale(CGAffineTransformIdentity, 1.0f, 1.0f);
                         }
                         completion:^(BOOL finished) {
                             [transitionContext completeTransition:YES];
                         }];
